...
(function(window, document, undefined) {
  ...
  angular.module('mgcrea.ngStrap.modal', [ 'mgcrea.ngStrap.core', 'mgcrea.ngStrap.helpers.dimensions' ]).provider('$strapModal', function() {
    var defaults = this.defaults = {
      animation: 'am-fade',
  ...
  }).directive('bsModal', [ '$window', '$sce', '$strapModal', function($window, $sce, $modal) {
    return {
      restrict: 'EAC',
      scope: true,
      link: function postLink(scope, element, attr, transclusion) {
  ...
  angular.module('mgcrea.ngStrap.aside', [ 'mgcrea.ngStrap.modal' ]).provider('$aside', function() {
    ...
    this.$get = [ '$strapModal', function($modal) {
  ...
  angular.module('mgcrea.ngStrap.alert', [ 'mgcrea.ngStrap.modal' ]).provider('$alert', function() {
    ...
    this.$get = [ '$strapModal', '$timeout', function($modal, $timeout) {
